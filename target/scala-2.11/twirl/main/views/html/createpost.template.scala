...
tinymce.init("""),format.raw/*22.14*/("""{"""),format.raw/*22.15*/("""
 ...
 """),format.raw/*29.2*/("""}"""),format.raw/*29.3*/(""");
    ...
    """),_display_(/*40.6*/helper/*40.12*/.form(action = routes.AdminsPosts.save(), 'id -> "createpostForm")/*40.78*/ {_display_(Seq[Any](format.raw/*40.80*/("""
		...
		"""),_display_(/*44.4*/helper/*44.10*/.checkbox(postForm("IsPhoto"), '_label -> Messages("для фотогаллерии"), 'cols -> "1", 'rows -> "1")),format.raw/*44.109*/("""
        """),format.raw/*45.74*/("""
        """),format.raw/*46.9*/("""<input type="submit" value="Сохранить">
    """)))}),format.raw/*47.6*/("""
""")))}),format.raw/*48.2*/("""

...
public class AdminsPosts extends Controller {
    ...
    public static Result update(Long postId) {
        ...
        if (postFromForm.getHtmlPreview() == null){
        	toUpdate.setHtmlPreview(TextUtils.generateTruncateHtmlPreview(toUpdate.getContent(), TRUNCATED_MEDIUM_CHAR_COUNT));
        }else{
...
//        Post.change(postId, postFromForm.title, postFromForm.content);
    ...
    public static Result save() {
        ...
        if (blogPost.getHtmlPreview() == null){
        	blogPost.setHtmlPreview(TextUtils.generateTruncateHtmlPreview(blogPost.getContent(), TRUNCATED_MEDIUM_CHAR_COUNT));
        }

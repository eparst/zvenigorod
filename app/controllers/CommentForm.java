...
public class CommentForm {
	...
	/*
	 * public String name = Application.getLocalUser(session().mail); public
	 * String email; public String randomID; public String code;
	 */
	public String validate() {
		...
		if (!content.isEmpty()) {
			...
			// Logger.debug("commentForm: failed - name=" + name + " - email=" +
